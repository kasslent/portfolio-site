		...
		<div class="wrap about-wrap">
			...
			<div>
				<div class="feature-section">
					...
					<div>
						<h4><?php _e( 'Premium Version', 'wpex' ); ?></h4>
						<p>
						<?php _e( 'You can purchase a premium version of the theme which includes many added benefits including styling options, auto updates and support.', 'wpex' ); ?>
						</p>
						<a href="https://creativemarket.com/wpexplorer/38505-Elegant-WordPress-Theme?u=wpexplorer" target="_blank" class="button button-primary"><?php _e( 'Premium Version', 'wpex' ); ?></a>
					</div>
					...
					<div>
						...
						<a href="http://www.wpexplorer.com/elegant-free-wordpress-theme/" target="_blank" class="button button-secodary"><?php _e( 'Theme Page', 'wpex' ); ?></a>
						<a href="http://www.wpexplorer.com/docs/free-theme-documentation/" target="_blank" class="button button-secodary"><?php _e( 'Documentation', 'wpex' ); ?></a>
					</div>
